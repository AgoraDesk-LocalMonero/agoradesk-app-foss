...
AppParameters initAppParameters({
  ...
  if (flavor == FlavorType.localmonero) {
    return AppParameters(
      ...
      torBaseUrl: 'http://2jopbxfi2mrw6pfpmufm7smacrgniglr7a4raaila3kwlhlumflxfxad.onion/api/v1',
      i2pBaseUrlOne: 'http://ztqnvu7c35jyoqmfjyymqggjpyky6z3tlgewk2qgbgcmcyl4ecta.b32.i2p/api/v1',
      ...
      telegramChannel: 'https://t.me/LocalMonero',
      matrixChannel: 'https://matrix.to/#/#localmonero:agoradesk.com',
      isAgora: false,
