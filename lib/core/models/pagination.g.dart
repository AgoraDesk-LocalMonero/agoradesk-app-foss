...
PaginationMeta _$PaginationMetaFromJson(Map<String, dynamic> json) => PaginationMeta(
...
Map<String, dynamic> _$PaginationMetaToJson(PaginationMeta instance) => <String, dynamic>{
