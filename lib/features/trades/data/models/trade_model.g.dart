...
_$_TradeModel _$$_TradeModelFromJson(Map<String, dynamic> json) => _$_TradeModel(
      ...
      advertisement: AttachedAdModel.fromJson(json['advertisement'] as Map<String, dynamic>),
      ...
      paymentCompletedAt: fromJsonDateOrNull(json['payment_completed_at'] as String?),
      ...
      transferToSellerTransactionId: json['transfer_to_seller_non_custodial_wallet_transaction_id'] as String?,
      transferToSellerConfirmations: json['transfer_to_seller_non_custodial_wallet_transaction_confirmations'] as int?,
      sellerNonCustodialWalletMnemonic: json['seller_non_custodial_wallet_mnemonic'] as String?,
      btcFeesEnum: $enumDecodeNullable(_$BtcFeesEnumEnumMap, json['buyer_settlement_fee_level']),
      buyerSettlementAddress: json['buyer_settlement_address'] as String?,
      transferToBuyerKey: json['transfer_to_buyer_settlement_wallet_transaction_key'] as String?,
      transferToBuyerTransactionId: json['transfer_to_buyer_settlement_wallet_transaction_id'] as String?,
    );
...
Map<String, dynamic> _$$_TradeModelToJson(_$_TradeModel instance) {
  ...
  writeNotNull('payment_completed_at', toJsonDateOrNull(instance.paymentCompletedAt));
  ...
  writeNotNull('transfer_to_seller_non_custodial_wallet_transaction_id', instance.transferToSellerTransactionId);
  writeNotNull(
      'transfer_to_seller_non_custodial_wallet_transaction_confirmations', instance.transferToSellerConfirmations);
  writeNotNull('seller_non_custodial_wallet_mnemonic', instance.sellerNonCustodialWalletMnemonic);
  writeNotNull('buyer_settlement_fee_level', _$BtcFeesEnumEnumMap[instance.btcFeesEnum]);
  writeNotNull('buyer_settlement_address', instance.buyerSettlementAddress);
  writeNotNull('transfer_to_buyer_settlement_wallet_transaction_key', instance.transferToBuyerKey);
  writeNotNull('transfer_to_buyer_settlement_wallet_transaction_id', instance.transferToBuyerTransactionId);
  return val;
}
