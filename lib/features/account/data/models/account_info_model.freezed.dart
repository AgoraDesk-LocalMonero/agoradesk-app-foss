...
class _$AccountInfoModelTearOff {
  ...
  _AccountInfoModel call(
    ...
    return _AccountInfoModel(
      ...
      confirmedTradeCount: confirmedTradeCount,
      tradeCount: tradeCount,
      localbitcoinsTradeCount: localbitcoinsTradeCount,
      localbitcoinsFeedbackScore: localbitcoinsFeedbackScore,
      localbitcoinsTradeVolume: localbitcoinsTradeVolume,
      localbitcoinsAccountCreatedAt: localbitcoinsAccountCreatedAt,
      paxfulTradeCount: paxfulTradeCount,
      paxfulFeedbackScore: paxfulFeedbackScore,
      paxfulTradeVolume: paxfulTradeVolume,
      paxfulAccountCreatedAt: paxfulAccountCreatedAt,
      lastOnline: lastOnline,
      createdAt: createdAt,
      feedbackCount: feedbackCount,
      feedbacksUnconfirmedCount: feedbacksUnconfirmedCount,
      tradingPartnersCount: tradingPartnersCount,
      releaseTimeMedium: releaseTimeMedium,
      hasCommonTrades: hasCommonTrades,
      ...
      sanctionExpiresAt: sanctionExpiresAt,
    );
  }
...
class _$_AccountInfoModel extends _AccountInfoModel {
  ...
  Map<String, dynamic> toJson() {
    return _$$_AccountInfoModelToJson(this);
  }
}
...
abstract class _AccountInfoModel extends AccountInfoModel {
  const factory _AccountInfoModel(
      ...
      @JsonKey(name: 'sanctioned_at', includeIfNull: false, fromJson: fromJsonDateOrNull, toJson: toJsonDateOrNull)
          DateTime? sanctionedAt,
      @JsonKey(name: 'sanction_expires_at', includeIfNull: false, fromJson: fromJsonDateOrNull, toJson: toJsonDateOrNull)
          DateTime? sanctionExpiresAt}) = _$_AccountInfoModel;
