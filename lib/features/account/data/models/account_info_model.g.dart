...
_$_AccountInfoModel _$$_AccountInfoModelFromJson(Map<String, dynamic> json) => _$_AccountInfoModel(
      ...
      localbitcoinsTradeVolume: (json['localbitcoins_trade_volume'] as num?)?.toDouble(),
      localbitcoinsAccountCreatedAt: json['localbitcoins_account_created_at'] == null
          ? null
      ...
      lastOnline: json['last_online'] == null ? null : DateTime.parse(json['last_online'] as String),
      ...
      myFeedback: $enumDecodeNullable(_$FeedbackTypeEnumMap, json['my_feedback']),
      introduction: json['introduction'] as String?,
      homepage: json['homepage'] as String?,
      sanctionReason: json['sanction_reason'] as String?,
      sanctionType: $enumDecodeNullable(_$SanctionTypeEnumMap, json['sanction_type']),
      sanctionedAt: fromJsonDateOrNull(json['sanctioned_at'] as String?),
      sanctionExpiresAt: fromJsonDateOrNull(json['sanction_expires_at'] as String?),
    );
...
Map<String, dynamic> _$$_AccountInfoModelToJson(_$_AccountInfoModel instance) {
  ...
  writeNotNull('localbitcoins_feedback_score', instance.localbitcoinsFeedbackScore);
  writeNotNull('localbitcoins_trade_volume', instance.localbitcoinsTradeVolume);
  writeNotNull('localbitcoins_account_created_at', instance.localbitcoinsAccountCreatedAt?.toIso8601String());
  ...
  writeNotNull('paxful_account_created_at', instance.paxfulAccountCreatedAt?.toIso8601String());
  ...
  writeNotNull('feedbacks_unconfirmed_count', instance.feedbacksUnconfirmedCount);
  ...
  writeNotNull('sanction_expires_at', toJsonDateOrNull(instance.sanctionExpiresAt));
  return val;
}
